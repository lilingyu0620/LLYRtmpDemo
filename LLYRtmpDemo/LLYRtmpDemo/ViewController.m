...
//#define RTMP_URL  @"rtmp://10.0.117.190/myapp/mystream" //@"rtmp://192.128.1.25/live/2005"
#define RTMP_URL  @"rtmp://10.0.117.190/myapp/mystream"

@interface ViewController ()<UIGestureRecognizerDelegate,LLYSessionsDelegate>
{
...
- (void)sessions:(LLYSessions *)session statusDidChanged:(LLYSessionState)status{
    switch (status) {
        ...
        case LLYSessionStateConnected:
        {
            ...
            [self.btn setTitle:@"结束" forState:UIControlStateNormal];
        }
            break;
        default:
        {
